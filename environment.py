...
class GymEnvironment(Environment):
	...
	"""
	def __init__(self):
		self.env = gym.make(Parameters.ENVIRONMENT, render_mode='rgb_array')
	...
	def display(self, ax, generation, team, step):
		ax.imshow(self.env.render())
		ax.set_title(f"{Parameters.ENVIRONMENT} Generation #{generation} Team {team.id} Step {step}")
		plt.axis('off')
